              ...
              <div className='d-flex flex-wrap flex-stack'>
                <div className='d-flex flex-column flex-grow-1 pe-8'>
                  <div className='d-flex flex-wrap'>
                    ...
                    <div className='w-450px border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3'>
                      <div className='fw-bold fs-6 text-gray-500'>{currentItem?.notes}</div>
                    </div>
                    <div className='w-250px border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3'>
